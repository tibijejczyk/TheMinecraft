...
public class ModChat extends GuiIngame
{
    ...
    public static void addNote(String nazwa, String wiadomosc, int type)
    {
    	Notification.add(new Notification((int)System.currentTimeMillis(), nazwa, wiadomosc, type));
    }
  ...
  set2DMode(0.0F, mc.displayWidth, 0.0F, mc.displayHeight);
        ...
        while(iterator1.hasNext()) 
        {
         ...
         this.drawCenteredString(var8, Kolory.zielony + s1 + Kolory.czerwony + notification.message, mc.displayWidth / 2  - (s1.length() / 2), k5, 0xffffff);
        	   ...
        	   // mod chat
        	   this.drawCenteredString(var8, Kolory.c_czerwony + s1 + Kolory.bialy + notification.message, mc.displayWidth / 2 / 2 + 150 - (s1.length() / 2), k5, 0xffffff);
